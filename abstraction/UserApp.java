...
class UserDaoImpl implements UserDao{
	...
	@Override
	public UserDto login(UserDto user) {return null;}
	...
	@Override
	public boolean selectIdCheck(String id) {return false;}

	@Override
	public UserDto selectUser(UserDto user) {return null;}

	@Override
	public UserDto[] selectUserList() {return null;}

	@Override
	public UserDto selectById(String id) {return null;}

	@Override
	public UserDto[] selectByName(String name) {return null;}

	@Override
	public int selectCount() {return 0;}
...
class UserController {
	...
	public void postJoin(UserDto user) {userService.join(user);}

	public UserDto postLogin(UserDto user) {return userService.login(user);}

	public void putUpdate(UserDto user) {userService.update(user);}

	public void deleteUser(UserDto user) {userService.delete(user);}
	
	public boolean getIdCheck(String id) {return userService.idCheck(id);}
	
	public UserDto getMypage(UserDto user) {return userService.mypage(user);}
	
	public UserDto[] getUserList() {return userService.userList();}
	
	public UserDto getIdSearch(String id) {return userService.idSearch(id);}
	
	public int getCountSameName(String name) {return userService.countSameName(name);}

	public UserDto[] getNameSearch(String name) {return userService.nameSearch(name);}
